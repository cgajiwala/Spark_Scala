...
config = {"mongo.input.uri": "mongodb://localhost:27017/mydb.mstf"}
...
sc = SparkContext(appName="mongoSparkApp") 
...
config = {"mongo.output.uri": "mongodb://localhost:27017/mydb.output"}
